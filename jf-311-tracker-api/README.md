...
sam build
# /jf-311-tracker-api/
sam sync --stack-name jf-311-tracker-api-dev --config-env dev --profile justfix-maxwell
sam local invoke --event events/event-schedule-updateComplaintStatus.json --config-env dev --profile justfix-maxwell
```

# Autogenerate document, and lots about the setup has been changed
...
```bash
sam delete --stack-name jf-311-tracker-api
```
